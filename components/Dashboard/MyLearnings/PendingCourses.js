...
function PendingCourses(item) {
  ...
  return (
    <div>
      <div className="dark:bg-[#0D567A] bg-white rounded-2xl mb-5 mt-9 mx-14 p-12">
        <div className="flex flex-col items-center lg:flex-row lg:justify-between w-full">
          ...
          {language == "ar" ? (
            <div className="flex flex-col items-center text-center lg:items-start md:w-6/12">
